...
const HomeComponent = () => {
  ...
  return (
    ...
    <section className='content w-full px-5 overflow-y-auto h-[calc(100vh-200px)]' >
                                                                ...
                                                                <div className='sq-container md:col-span-1 px-2 py-3 bg-white bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-20 rounded-3xl w-80 h-80' >
                                                                        <header className='flex px-3' >
                                                                                <div className='flex flex-col' >
                                                                                        ...
                                                                                        {/* <p className='text-xs text-gray-700' >Wednesday, 11 May</p> */}
                                                                                        ...
                                                                                        {users?.map((user) => (
                                                                                                <li key={user._id} className='py-2'>
                                                                                                        <div className='flex justify-around ' >
                                                                                                                ...
                                                                                                                <div className='w-48'>
                                                                                                                        <h3 className='flex text-sm text-gray-900 font-medium overflow-ellipsis overflow-hidden whitespace-nowrap' >{user.firstname} {user.lastname}</h3>
                                                                                ...
                                                                                {events?.map((event) => (
                                                                                        <li key={event._id} className='py-2 list-none'>
                                                                                                <div className='flex justify-around ' >
                                                                                                        ...
                                                                                                        <div className='w-80'>
                                                                                                                <h3 className='flex text-sm text-gray-900 font-medium overflow-ellipsis overflow-hidden whitespace-nowrap' >{event.title}</h3>
                                                                                                                <p className='text-xs text-gray-700' >{event.isGroupEvent ? "Group" : "Individual"}</p>
                                                                                                                <p className='flex' > <Users className='w-4' /> {event?.participants.length}</p>
                                                                                                        </div>
                                                                                                        <p className='text-xs text-gray-700' >{new Date(event.createdAt).toLocaleDateString('en-GB', { day: 'numeric', month: 'long', year: 'numeric' })}</p>
                                                                                                </div>
                                                                                                <hr />
                                                                                        </li>
                                                                                ))}
                                                        ...
                                                        <div className='row2 py-5 row-span-1 md:grid grid-flow-col grid-cols-3 ' >
                                                                <div className='sq-container md:col-span-1 px-2 py-3 bg-white bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-20 rounded-3xl w-80 h-80' >
                                                                        <header className='flex px-3' >
                                                                                <div className='flex flex-col' >
                                                                                        <h3 className='font-semibold text-black' >To-do list</h3>
                                                                                        <p className='text-xs text-gray-700' >Wednesday, 11 May</p>
                                                                                </div>
                                                                        </header>
                                                                        <div className='bg-gray-100 rounded-xl h-60 px-2 my-2 overflow-scroll' >
                                                                ...
                                                                <div className='rect-container md:col-span-2 px-2 py-3 bg-white bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-20 rounded-3xl w-full h-80' >
                                                                        <header className='flex px-3' >
                                                                                <div className='flex flex-col' >
                                                                                        <h3 className='font-semibold text-black' >My activity</h3>
                                                                                        <p className='text-xs text-gray-700' >What is waiting for you today</p>
                                                                                </div>
                                                                        </header>
                                                                        <div className='bg-gray-100 rounded-xl h-60 px-2 my-2 overflow-scroll' >
                                                        ...
                                                        <div className='row3 py-1 md:py-8 row-span-1 md:grid grid-flow-col grid-cols-3 ' >
